          ...
          <nav class="navbar fixed-top navbar-expand-sm navbar-dark ml-auto " style="background-color:#015c92">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                  <div class="dropdown">
                   <a  href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><i class="fa fa-database"></i> Database </a>
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="dataanggota.php" ><i class="fa fa-users"></i> Anggota</a>
                      <a class="dropdown-item" href="pengunjung.php" ><i class="fa fa-car"></i> Pengunjung</a>
                      <a class="dropdown-item" href="transaksi.php" ><i class="fa fa-hand-holding-usd"></i> Transaksi</a>
                    </div>
                  </div>
                </li>
                <li class="nav-item">
                  <div class="dropdown">
                   <a  href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><i class="fa fa-cogs"></i> Pengaturan </a>
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="tarif.php"><i class="fa fa-file-invoice-dollar"></i> Tarif</a>
                      <a class="dropdown-item" href="dataslot.php"><i class="fa fa-map-marker-alt"></i> Slot Parkir</a>
